...
//   }
	...
	public Mainpa2(Member loginUser) {
...
//      HumanMangement.add(btnNewButton_1);
		...
		scrollPane.setBounds(0, 200, 991, 600);
...
//      show();
		...
		for (int i = 0; i < 12; i++) {
			달력뷰.add(new CalendarCard2((i + 1) + "월", numOfdays[i]));
		}
...
//                              panel_1.setBackground(Color.WHITE);
//                              panel_1.setBounds(0, 150, 900, 459);
//                              달력패널.add(panel_1);
//                              panel_1.setLayout(null);
//                              
//                              JScrollPane scrollPane_1 = new JScrollPane();
//                              scrollPane_1.setBounds(0, 20, 850, 430);
//                              panel_1.add(scrollPane_1);
		...
		label.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				JOptionPane.showMessageDialog(null, "접근할 수 없는 권한입니다.", "오류", JOptionPane.WARNING_MESSAGE);
		...
		환영합니다.setBounds(130, 102, 112, 30);
		panel.add(환영합니다);
